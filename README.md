...
| 4 | Send a link to the most complex Python code you have written |[`[q3_csv_import/](https://leetcode.com/problems/longest-consecutive-sequence/description/)`](q4_leetcode)|
| 5 | Send a link to the most complex database code you have written |[`[[q3_csv_import/](https://leetcode.com/problems/longest-consecutive-sequence/description/)](https://leetcode.com/problems/second-highest-salary/description/)`](q5_leetcode)|
