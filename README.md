...
| 4 | Send a link to the most complex Python code you have written |[`https://leetcode.com/problems/longest-consecutive-sequence/description/`](https://leetcode.com/problems/longest-consecutive-sequence/description/)|
| 5 | Send a link to the most complex database code you have written |[`https://leetcode.com/problems/second-highest-salary/description/`](https://leetcode.com/problems/second-highest-salary/description/)|
